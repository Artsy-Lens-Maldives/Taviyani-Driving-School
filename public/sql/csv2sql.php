...
<form class="form-horizontal"action="/sql/csv2sql.php" method="post">
	...
	<div class="form-group">
		...
		<div class="col-xs-3">
        <input type="text" class="form-control" name="db" id="db" placeholder="" value="taviyani_driving">
		</div>
    </div>
	...
	<div class="form-group">
		...
		<div class="col-xs-3">
        <input type="name" class="form-control" name="table" id="table" value="people">
		</div>
    </div>
	<div class="form-group">
        <label for="csvfile" class="control-label col-xs-2">Name of the file</label>
		<div class="col-xs-3">
        <input type="name" class="form-control" name="csv" id="csv" value="people.csv">
		</div>
		eg. MYDATA.csv
    </div>
	<div class="form-group">
